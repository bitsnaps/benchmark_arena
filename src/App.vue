      ...
      <div class="wrap" style="display:flex;width:min(1240px,calc(100% - 2rem));">
        ...
        <div class="navbar-menu" :class="{ 'is-active': menuOpen }">
          <div class="navbar-start">
            ...
            <router-link class="navbar-item" :class="{ 'is-active': route.name === 'advisor' }"
              :to="{ name: 'advisor' }" @click="menuOpen = false">Advisor</router-link>
            ...
            <router-link class="navbar-item" :class="{ 'is-active': route.name === 'value' }"
            ...
            <!-- stats-45: Methodology sits at the end of the menu -->
            <router-link class="navbar-item" :class="{ 'is-active': route.name === 'methodology' }"
              :to="{ name: 'methodology' }" @click="menuOpen = false">Methodology</router-link>
          </div>
